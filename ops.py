...
size = (I-k+1+2p) // s
"""
def conv(x, channels, kernel=4, stride=2, pad=1,  scope='conv_0', weight_init = weight_init):
...
def deconv(x, channels, kernel=4, stride=2, scope='deconv_0', weight_init = weight_init):
    with tf.variable_scope(scope):
